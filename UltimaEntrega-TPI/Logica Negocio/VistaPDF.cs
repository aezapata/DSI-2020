...
namespace UltimaEntrega_TPI.Logica_Negocio
{
    public class VistaPDF:IFormasVisualizacion
    {
        ...
        public void AgregarFila(string sectores, string estados, Object calculosMax, Object calculosMin, Object calculosProm)
        {
            ...
            List<Cell> fila = SetFila(estados, sectores, calculosMax, calculosMin, calculosProm);
        ...
        public List<Cell> SetFila(string sectores, string estados, Object calculosMax, Object calculosMin, Object calculosProm)
        {
            ...
            fila.Add(cellx1); fila.Add(cellx2); fila.Add(cellx3); fila.Add(cellx4); fila.Add(cellx5);
            return fila;
        }
        ...
        public void SetPiePagina(string usuario, DateTime fechaHoraActual, int numeroPagina) 
        {
        ...
        {
            Paragraph header = new Paragraph(titulo + " " + fechaDesde.ToString() +  " - "+ fechaHasta.ToString())
                                .SetTextAlignment(TextAlignment.CENTER)
                                .SetFontSize(20);
